...
import { acentricFactor, assessCrystallisation, assessDistillation, bubblePoint, fenskeMinimumStages, idealSolubility, knownAzeotrope, nonIdealityFromHansen, relativeVolatility, solubilityToGrams, txyDiagram } from "../src";
...
const water: PureComponent = { name: "water", molarMass: 18.015, tb: 373.15, tc: 647.1, pc: 220.64, omega: 0.344, hvapTb: 40.66, tm: 273.15, hfus: 6.01, hansen: { dd: 15.5, dp: 16.0, dh: 42.3 }, provenance: "measured" };
