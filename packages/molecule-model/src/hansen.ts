...
const S = (id: string, name: string, dd: number, dp: number, dh: number, bp: number, chem21: Chem21Class, note?: string): Solvent => (note === undefined ? { id, name, dd, dp, dh, bp, chem21 } : { id, name, dd, dp, dh, bp, chem21, note });

export const SOLVENTS: readonly Solvent[] = [
  S("water", "Water", 15.5, 16.0, 42.3, 100, "recommended"),
  S("ethanol", "Ethanol", 15.8, 8.8, 19.4, 78.4, "recommended"),
  S("2-propanol", "2-Propanol", 15.8, 6.1, 16.4, 82.6, "recommended"),
  S("1-butanol", "1-Butanol", 16.0, 5.7, 15.8, 117.7, "recommended"),
  S("ethyl-acetate", "Ethyl acetate", 15.8, 5.3, 7.2, 77.1, "recommended"),
  S("isopropyl-acetate", "Isopropyl acetate", 14.9, 4.5, 8.2, 88.6, "recommended"),
  S("butyl-acetate", "n-Butyl acetate", 15.8, 3.7, 6.3, 126.1, "recommended"),
  S("anisole", "Anisole", 17.8, 4.4, 6.9, 153.7, "recommended"),
  S("sulfolane", "Sulfolane", 20.3, 18.2, 10.9, 285, "recommended"),
  S("methanol", "Methanol", 15.1, 12.3, 22.3, 64.7, "problematic", "acute toxicity"),
  S("tert-butanol", "tert-Butanol", 15.2, 5.1, 14.7, 82.4, "problematic", "low flash point"),
  S("benzyl-alcohol", "Benzyl alcohol", 18.4, 6.3, 13.7, 205.3, "problematic", "high boiling point"),
  S("ethylene-glycol", "Ethylene glycol", 17.0, 11.0, 26.0, 197.3, "problematic", "high boiling point"),
  S("acetone", "Acetone", 15.5, 10.4, 7.0, 56.1, "problematic", "low flash point"),
  S("mek", "2-Butanone (MEK)", 16.0, 9.0, 5.1, 79.6, "problematic", "low flash point"),
  S("mibk", "Methyl isobutyl ketone", 15.3, 6.1, 4.1, 116.5, "problematic", "flammability"),
  S("cyclohexanone", "Cyclohexanone", 17.8, 6.3, 5.1, 155.6, "problematic", "high boiling point"),
  S("methyl-acetate", "Methyl acetate", 15.5, 7.2, 7.6, 56.9, "problematic", "low flash point"),
  S("acetic-acid", "Acetic acid", 14.5, 8.0, 13.5, 117.9, "problematic", "corrosive"),
  S("acetic-anhydride", "Acetic anhydride", 16.0, 11.7, 10.2, 139.8, "problematic", "corrosive"),
  S("thf", "Tetrahydrofuran", 16.8, 5.7, 8.0, 66, "problematic", "peroxide formation, low flash point"),
  S("2-methf", "2-Methyltetrahydrofuran", 16.9, 5.0, 4.3, 80.2, "problematic", "peroxide formation"),
  S("heptane", "Heptane", 15.3, 0.0, 0.0, 98.4, "problematic", "flammability"),
  S("methylcyclohexane", "Methylcyclohexane", 16.0, 0.0, 1.0, 100.9, "problematic", "flammability"),
  S("toluene", "Toluene", 18.0, 1.4, 2.0, 110.6, "problematic", "reproductive toxicity concern"),
  S("xylene", "Xylenes", 17.8, 1.0, 3.1, 139, "problematic", "flammability, toxicity"),
  S("chlorobenzene", "Chlorobenzene", 19.0, 4.3, 2.0, 131.7, "problematic", "halogenated, aquatic toxicity"),
  S("acetonitrile", "Acetonitrile", 15.3, 18.0, 6.1, 81.6, "problematic", "toxicity"),
  S("dmso", "Dimethyl sulfoxide", 18.4, 16.4, 10.2, 189, "problematic", "high boiling point"),
  S("mtbe", "MTBE", 15.2, 3.4, 5.0, 55.2, "hazardous", "low flash point, groundwater contaminant"),
  S("cyclohexane", "Cyclohexane", 16.8, 0.0, 0.2, 80.7, "hazardous", "flammability, aquatic toxicity"),
  S("dcm", "Dichloromethane", 17.0, 7.3, 7.1, 39.6, "hazardous", "suspected carcinogen, volatile halogenated"),
  S("formic-acid", "Formic acid", 14.3, 11.9, 16.6, 100.8, "hazardous", "corrosive"),
  S("pyridine", "Pyridine", 19.0, 8.8, 5.9, 115.2, "hazardous", "toxicity, low flash point"),
  S("dmf", "N,N-Dimethylformamide", 17.4, 13.7, 11.3, 153, "hazardous", "reproductive toxicity (H360)"),
  S("dmac", "N,N-Dimethylacetamide", 16.8, 11.5, 10.2, 165, "hazardous", "reproductive toxicity (H360)"),
  S("nmp", "N-Methylpyrrolidone", 18.0, 12.3, 7.2, 202, "hazardous", "reproductive toxicity (H360)"),
  S("dioxane", "1,4-Dioxane", 17.5, 1.8, 9.0, 101.1, "hazardous", "suspected carcinogen, peroxides"),
  S("dme", "1,2-Dimethoxyethane", 15.4, 6.3, 6.0, 85, "hazardous", "reproductive toxicity, peroxides"),
  S("pentane", "Pentane", 14.5, 0.0, 0.0, 36.1, "hazardous", "very low flash point"),
  S("hexane", "Hexane", 14.9, 0.0, 0.0, 68.7, "hazardous", "neurotoxicity, reproductive toxicity concern"),
  S("diethyl-ether", "Diethyl ether", 14.5, 2.9, 4.6, 34.6, "highly hazardous", "extremely flammable, peroxides"),
  S("benzene", "Benzene", 18.4, 0.0, 2.0, 80.1, "highly hazardous", "carcinogen"),
  S("chloroform", "Chloroform", 17.8, 3.1, 5.7, 61.2, "highly hazardous", "suspected carcinogen, toxic"),
  S("ccl4", "Carbon tetrachloride", 17.8, 0.0, 0.6, 76.7, "highly hazardous", "toxic, ozone depleting"),
  S("dce", "1,2-Dichloroethane", 19.0, 7.4, 4.1, 83.5, "highly hazardous", "carcinogen"),
  S("nitromethane", "Nitromethane", 15.8, 18.8, 5.1, 101.2, "highly hazardous", "explosive hazard"),
];
